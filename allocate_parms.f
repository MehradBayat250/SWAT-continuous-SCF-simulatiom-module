...
!    Drainmod tile equations  01/2006 
      ...
      allocate (snocov_me(mhru))
      allocate (snocov_elev_me(10,mhru))
       allocate (SCF_me(mhru))
      allocate (snocovmx_me(mhru))
      allocate (sno50cov_me(mhru))
      allocate (sftmp_me(mhru))
      allocate (smfmn_me(mhru))
      allocate (smfmx_me(mhru))
      allocate (smtmp_me(mhru))
      allocate (timp_me(mhru))
       allocate (sub_SCF(msub))
