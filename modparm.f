      ...
      integer rooze !number of day
      integer kodom
      real, dimension (:), allocatable :: snocov_me
      real, dimension (:), allocatable :: snocovmx_me, sno50cov_me
      real, dimension (:), allocatable :: sftmp_me, smfmn_me, smfmx_me
      real, dimension (:), allocatable :: smtmp_me, timp_me,  SCF_me
      real, dimension (:,:), allocatable :: tavband_me, snocov_elev_me
       real, dimension (:), allocatable :: sub_SCF
